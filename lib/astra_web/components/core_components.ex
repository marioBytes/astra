defmodule AstraWeb.CoreComponents do
  @moduledoc """
  ...
  def button_base(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "disabled:bg-zinc-200 disabled:text-zinc-900",
        @class
      ]}
      {@rest}
    >
  ...
  def button_primary(assigns) do
    ...
    <.button_base
      type={@type}
      class="bg-zinc-900 hover:bg-zinc-700 text-white active:text-white/80 disabled:bg-zinc-200 disabled:text-zinc-900"
      {@rest}
    >
      <%= render_slot(@inner_block) %>
    </.button_base>
  ...
  def button_secondary(assigns) do
    ...
    <.button_base
      type={@type}
      class="bg-white hover:bg-zinc-200 text-zinc-900 active:text-zinc/80 disabled:text-zinc-500"
      {@rest}
    >
      <%= render_slot(@inner_block) %>
    </.button_base>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AstraWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AstraWeb.Gettext, "errors", msg, opts)
    end
  end
